...
class TestHalConstruction extends PlaySpec {
  ...
  "A HAL relation" should {
    ...
    "be a single link through HalSingleRelation writes" in {
    ...
    "embed links by adding HAL resource" in {
  ...
  "A HAL links function" should {
    ...
    "can be used to add relations together" in {
      val resource =
